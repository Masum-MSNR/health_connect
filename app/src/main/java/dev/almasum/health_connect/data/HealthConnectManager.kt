 ...
 */
package dev.almasum.health_connect.data
...
class HealthConnectManager(private val context: Context) {
    ...
    var availability = MutableLiveData(SDK_UNAVAILABLE)
        private set
     ...
     * [dev.almasum.health_connect.presentation.screen.recordlist.RecordType] enum.
     */
